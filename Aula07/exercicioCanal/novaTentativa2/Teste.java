...
public class Teste {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Quantidade de vídeos do canal2:" + canal2.quantidadeDeVideos()); //erro
        System.out.println("Quantidade de playlists do canal1:" + canal1.quantidadeDePlaylists());
        System.out.println("Quantidade de vídeos na playlist 'PlayList 1':" + playList.quantidadeDeVideos()); //erro
